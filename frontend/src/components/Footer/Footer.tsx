...
const Footer: React.FC = () => {
    ...
    return (
        ...
        <>
                <div className="bg-[#069efd] py-4 text-white font-poppins shadow-[0_-4px_10px_-2px_rgba(0,0,0,0.3)]
">
                                    ...
                                    <svg version="1.1" viewBox="0 0 3368 512" xmlns="http://www.w3.org/2000/svg">
                                        <g fill="none" fillRule="evenodd">
                                            <g transform="translate(0 -75)">
                                                <g transform="translate(0 75)">
                                                    <image href={logo} x="85" y="70" width="400" height="400" />
                                                </g>
                                                <text fill="white" font-poppins fontSize="500" fontWeight="bold">
                                                    <tspan x="654" y="518">Event Link</tspan>
                                                </text>
                                            </g>
                                        </g>
                                    </svg>
            ...
            <div>
              <h2 className="inline-block text-2xl pb-4 mb-4 border-b-4 border-[#FC8239]">Connect With Us</h2>
            </div>
            <a href="#" className="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full mr-1 hover:text-[#FC8239] hover:border-[#FC8239]">
            ...
            <a href="#" className="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full hover:text-[#FC8239] hover:border-[#FC8239]">
